...
uses
  ...
  Vcl.ActnList, System.ImageList, Vcl.ImgList, cxGraphics, cxControls,
  cxLookAndFeels, cxLookAndFeelPainters, dxSkinscxPCPainter, dxBarBuiltInMenu,
  cxPC, GridFrame, ParametersForCategoriesView, CategoryParametersView;

type
  TFrameCategoryParameters = class(TFrame)
    dxBarManager: TdxBarManager;
    ActionList: TActionList;
    actShowCategorized: TAction;
    actShowList: TAction;
    dxBarButton1: TdxBarButton;
    dxBarButton2: TdxBarButton;
    cxImageList: TcxImageList;
    cxPageControl1: TcxPageControl;
    cxtsCategorized: TcxTabSheet;
    cxtsList: TcxTabSheet;
