inherited QuerySearchParameter: TQuerySearchParameter
  ...
  object FDUpdateSQL: TFDUpdateSQL
    InsertSQL.Strings = (
      ...
      '  :NEW_ISCUSTOMPARAMETER, :NEW_IDPARAMETERTYPE);'
      'SELECT ID, VALUE, VALUET, CODELETTERS, MEASURINGUNIT, '
      
        '  TABLENAME, DEFINITION, "ORDER" AS "ORDER", FIELDTYPE,  ISCUSTO' +
        'MPARAMETER, IDPARAMETERTYPE'
      'FROM PARAMETERS'
    ...
    ModifySQL.Strings = (
      'UPDATE PARAMETERS'
        ...
        '= :NEW_FIELDTYPE, '
      '  ISCUSTOMPARAMETER = :NEW_ISCUSTOMPARAMETER, '
